...
revoke references on table "public"."part_files" from "anon";

revoke truncate on table "public"."part_files" from "anon";

revoke references on table "public"."part_files" from "authenticated";

revoke truncate on table "public"."part_files" from "authenticated";

revoke references on table "public"."parts" from "anon";

revoke truncate on table "public"."parts" from "anon";

revoke references on table "public"."parts" from "authenticated";

revoke truncate on table "public"."parts" from "authenticated";

revoke delete on table "public"."provider_messages" from "anon";

revoke insert on table "public"."provider_messages" from "anon";

revoke references on table "public"."provider_messages" from "anon";

revoke select on table "public"."provider_messages" from "anon";

revoke trigger on table "public"."provider_messages" from "anon";

revoke truncate on table "public"."provider_messages" from "anon";

revoke update on table "public"."provider_messages" from "anon";

revoke delete on table "public"."provider_package_files" from "anon";

revoke insert on table "public"."provider_package_files" from "anon";

revoke references on table "public"."provider_package_files" from "anon";

revoke select on table "public"."provider_package_files" from "anon";

revoke trigger on table "public"."provider_package_files" from "anon";

revoke truncate on table "public"."provider_package_files" from "anon";

revoke update on table "public"."provider_package_files" from "anon";

revoke references on table "public"."provider_package_files" from "authenticated";

revoke truncate on table "public"."provider_package_files" from "authenticated";

revoke delete on table "public"."provider_quote_rounds" from "anon";

revoke insert on table "public"."provider_quote_rounds" from "anon";

revoke references on table "public"."provider_quote_rounds" from "anon";

revoke select on table "public"."provider_quote_rounds" from "anon";

revoke trigger on table "public"."provider_quote_rounds" from "anon";

revoke truncate on table "public"."provider_quote_rounds" from "anon";

revoke update on table "public"."provider_quote_rounds" from "anon";

revoke delete on table "public"."provider_quotes" from "anon";

revoke insert on table "public"."provider_quotes" from "anon";

revoke references on table "public"."provider_quotes" from "anon";

revoke select on table "public"."provider_quotes" from "anon";

revoke trigger on table "public"."provider_quotes" from "anon";

revoke truncate on table "public"."provider_quotes" from "anon";

revoke update on table "public"."provider_quotes" from "anon";

revoke delete on table "public"."provider_relationships" from "anon";

revoke insert on table "public"."provider_relationships" from "anon";

revoke references on table "public"."provider_relationships" from "anon";

revoke select on table "public"."provider_relationships" from "anon";

revoke trigger on table "public"."provider_relationships" from "anon";

revoke truncate on table "public"."provider_relationships" from "anon";

revoke update on table "public"."provider_relationships" from "anon";

revoke delete on table "public"."provider_request_events" from "anon";

revoke insert on table "public"."provider_request_events" from "anon";

revoke references on table "public"."provider_request_events" from "anon";

revoke select on table "public"."provider_request_events" from "anon";

revoke trigger on table "public"."provider_request_events" from "anon";

revoke truncate on table "public"."provider_request_events" from "anon";

revoke update on table "public"."provider_request_events" from "anon";

revoke delete on table "public"."provider_request_packages" from "anon";

revoke insert on table "public"."provider_request_packages" from "anon";

revoke references on table "public"."provider_request_packages" from "anon";

revoke select on table "public"."provider_request_packages" from "anon";

revoke trigger on table "public"."provider_request_packages" from "anon";

revoke truncate on table "public"."provider_request_packages" from "anon";

revoke update on table "public"."provider_request_packages" from "anon";

revoke references on table "public"."provider_request_packages" from "authenticated";

revoke truncate on table "public"."provider_request_packages" from "authenticated";

revoke delete on table "public"."provider_schedule_entries" from "anon";

revoke insert on table "public"."provider_schedule_entries" from "anon";

revoke references on table "public"."provider_schedule_entries" from "anon";

revoke select on table "public"."provider_schedule_entries" from "anon";

revoke trigger on table "public"."provider_schedule_entries" from "anon";

revoke truncate on table "public"."provider_schedule_entries" from "anon";

revoke update on table "public"."provider_schedule_entries" from "anon";

revoke delete on table "public"."provider_sites" from "anon";

revoke insert on table "public"."provider_sites" from "anon";

revoke references on table "public"."provider_sites" from "anon";

revoke select on table "public"."provider_sites" from "anon";

revoke trigger on table "public"."provider_sites" from "anon";

revoke truncate on table "public"."provider_sites" from "anon";

revoke update on table "public"."provider_sites" from "anon";
...
CREATE TRIGGER on_auth_user_created AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION public.handle_new_user_profile();
  ...
  create policy "Users can delete files for parts in their organization"
  on "storage"."objects"
  as permissive
  for delete
  to authenticated
using (((bucket_id = 'part-files'::text) AND (EXISTS ( SELECT 1
   FROM ((public.part_files pf
     JOIN public.parts p ON ((p.id = pf.part_id)))
     JOIN public.organization_members om ON ((om.organization_id = p.organization_id)))
  WHERE ((pf.storage_path = objects.name) AND (om.user_id = auth.uid()) AND (om.role = ANY (ARRAY['admin'::text, 'engineer'::text])))))));



  create policy "Users can delete request files in their organization"
  on "storage"."objects"
  as permissive
  for delete
  to authenticated
using (((bucket_id = 'service-request-files'::text) AND (EXISTS ( SELECT 1
   FROM ((public.service_request_uploaded_files sru
     JOIN public.service_requests sr ON ((sr.id = sru.service_request_id)))
     JOIN public.organization_members om ON ((om.organization_id = sr.organization_id)))
  WHERE ((sru.storage_path = objects.name) AND (om.user_id = auth.uid()) AND (om.role = ANY (ARRAY['admin'::text, 'engineer'::text])) AND (sr.status = ANY (ARRAY['draft'::text, 'submitted'::text, 'in_review'::text, 'awaiting_customer'::text])))))));



  create policy "Users can update files for parts in their organization"
  on "storage"."objects"
  as permissive
  for update
  to authenticated
using (((bucket_id = 'part-files'::text) AND (EXISTS ( SELECT 1
   FROM ((public.part_files pf
     ...
     JOIN public.organization_members om ON ((om.organization_id = p.organization_id)))
  WHERE ((pf.storage_path = objects.name) AND (om.user_id = auth.uid()) AND (om.role = ANY (ARRAY['admin'::text, 'engineer'::text])))))))
with check ((bucket_id = 'part-files'::text));



  create policy "Users can update request files in their organization"
  on "storage"."objects"
  as permissive
  for update
  to authenticated
using (((bucket_id = 'service-request-files'::text) AND (EXISTS ( SELECT 1
   FROM ((public.service_request_uploaded_files sru
     ...
     JOIN public.organization_members om ON ((om.organization_id = sr.organization_id)))
  WHERE ((sru.storage_path = objects.name) AND (om.user_id = auth.uid()) AND (om.role = ANY (ARRAY['admin'::text, 'engineer'::text])) AND (sr.status = ANY (ARRAY['draft'::text, 'submitted'::text, 'in_review'::text, 'awaiting_customer'::text])))))))
with check ((bucket_id = 'service-request-files'::text));



  create policy "Users can upload files for parts in their organization"
  on "storage"."objects"
  as permissive
  for insert
  to authenticated
with check (((bucket_id = 'part-files'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));



  create policy "Users can upload request files in their organization"
  on "storage"."objects"
  as permissive
  for insert
  to authenticated
with check (((bucket_id = 'service-request-files'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));



  create policy "Users can view files for parts in their organization"
  on "storage"."objects"
  as permissive
  for select
  to authenticated
using (((bucket_id = 'part-files'::text) AND (EXISTS ( SELECT 1
   FROM ((public.part_files pf
     JOIN public.parts p ON ((p.id = pf.part_id)))
     JOIN public.organization_members om ON ((om.organization_id = p.organization_id)))
  WHERE ((pf.storage_path = objects.name) AND (om.user_id = auth.uid()))))));



  create policy "Users can view request files in their organization"
  on "storage"."objects"
  as permissive
  for select
  to authenticated
using (((bucket_id = 'service-request-files'::text) AND (EXISTS ( SELECT 1
   FROM ((public.service_request_uploaded_files sru
     JOIN public.service_requests sr ON ((sr.id = sru.service_request_id)))
     JOIN public.organization_members om ON ((om.organization_id = sr.organization_id)))
  WHERE ((sru.storage_path = objects.name) AND (om.user_id = auth.uid()))))));



  create policy "provider_assets_delete"
  on "storage"."objects"
  as permissive
  for delete
  to authenticated
using (((bucket_id = 'provider-assets'::text) AND (EXISTS ( SELECT 1
   FROM public.organization_members om
  WHERE ((om.organization_id = ((storage.foldername(objects.name))[1])::uuid) AND (om.user_id = auth.uid()) AND (om.role = ANY (ARRAY['admin'::text, 'engineer'::text])))))));



  create policy "provider_assets_insert"
  on "storage"."objects"
  as permissive
  for insert
  to authenticated
with check (((bucket_id = 'provider-assets'::text) AND (EXISTS ( SELECT 1
   FROM public.organization_members om
  WHERE ((om.organization_id = ((storage.foldername(objects.name))[1])::uuid) AND (om.user_id = auth.uid()) AND (om.role = ANY (ARRAY['admin'::text, 'engineer'::text])))))));
  ...
  for select
  to authenticated
using (((bucket_id = 'provider-assets'::text) AND (public.is_org_member(((storage.foldername(name))[1])::uuid) OR (EXISTS ( SELECT 1
   FROM public.provider_relationships pr
  WHERE ((pr.provider_org_id = ((storage.foldername(objects.name))[1])::uuid) AND public.is_org_member(pr.customer_org_id) AND (pr.relationship_status = ANY (ARRAY['invited'::public.provider_relationship_status, 'active'::public.provider_relationship_status]))))))));



  create policy "provider_assets_update"
  on "storage"."objects"
  as permissive
  for update
  to authenticated
...
with check (((bucket_id = 'provider-assets'::text) AND (EXISTS ( SELECT 1
  ...
  create policy "provider_invoices_storage_delete"
  on "storage"."objects"
  as permissive
  for delete
  to authenticated
using (((bucket_id = 'provider-invoices'::text) AND (EXISTS ( SELECT 1
   FROM public.organization_members om
  WHERE ((om.organization_id = ((storage.foldername(objects.name))[1])::uuid) AND (om.user_id = auth.uid()) AND (om.role = ANY (ARRAY['admin'::text, 'engineer'::text])))))));



  create policy "provider_invoices_storage_insert"
  on "storage"."objects"
  as permissive
  for insert
  to authenticated
with check (((bucket_id = 'provider-invoices'::text) AND (EXISTS ( SELECT 1
   FROM public.organization_members om
  WHERE ((om.organization_id = ((storage.foldername(objects.name))[1])::uuid) AND (om.user_id = auth.uid()) AND (om.role = ANY (ARRAY['admin'::text, 'engineer'::text])))))));



  create policy "provider_invoices_storage_select"
  on "storage"."objects"
  as permissive
  for select
  to authenticated
using (((bucket_id = 'provider-invoices'::text) AND (EXISTS ( SELECT 1
   FROM (public.provider_invoices pi
     JOIN public.organization_members om ON (((om.organization_id = pi.provider_org_id) OR (om.organization_id = pi.customer_org_id))))
  WHERE ((om.user_id = auth.uid()) AND (pi.uploaded_file_path = objects.name))))));



  create policy "provider_invoices_storage_update"
  on "storage"."objects"
  as permissive
  for update
  to authenticated
