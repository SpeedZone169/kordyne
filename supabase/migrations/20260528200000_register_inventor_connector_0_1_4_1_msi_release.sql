-- Register Inventor connector 0.1.4.1 beta release.
-- This patch keeps the 0.1.4 functional surface and updates the Inventor
-- connector shell with Onshape-matched icons, responsive label sizing, and a
-- dockable panel that does not force itself back to the old narrow width.
...
with upserted_release as (
  ...
  values (
    ...
    'application/x-msi',
    4616192,
    'E695E7BAA86D282A3F06A3AEA0C7B683F1DFBC9EA21C41CE5173C97379B25CDB',
    'Inventor connector MSI patch keeps the 0.1.4 workflow and updates the panel shell with Onshape-matched line icons, safer responsive label sizing, a cleaner Connect card, and a dockable panel that preserves user width changes.',
    true,
    jsonb_build_object(
      'downloadable', true,
