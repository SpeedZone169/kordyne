      ...
      <section className="mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-6 py-20">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Store, quote, and source engineered parts across 3D printing, composite
            and CNC workflows from one enterprise-ready platform.
          </p>
        ...
        <div className="mt-20 grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-3xl border border-gray-200 p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-6 text-gray-600">
              Request and manage quotes for composite parts, 3D printed and CNC
              with clarity.
            </p>
          </div>
