      ...
      <div className="mx-auto max-w-2xl px-6 py-16">
        <div className="rounded-[28px] border border-zinc-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-600">
            Your account already has an authenticator app enrolled. Continue to the
            verify step to finish sign-in.
          </p>
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16">
      <div className="rounded-[28px] border border-zinc-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 text-sm leading-6 text-slate-600">
          Use any authenticator app or password manager that supports one-time codes.
          Scan the QR code below, then enter the 6-digit code it generates.
        </p>

        <div className="mt-4 rounded-[18px] border border-zinc-200 bg-[#fafaf9] px-4 py-3 text-sm text-slate-700">
          <p className="font-medium text-slate-900">How to set it up</p>
          <ol className="mt-2 list-decimal space-y-1 pl-5">
            <li>Open an authenticator app on your phone or password manager.</li>
        ...
        {secret ? (
          <div className="mt-6 rounded-[18px] border border-zinc-200 bg-[#fafaf9] px-4 py-3">
            ...
            <p className="mt-2 text-sm text-slate-600">
              If scanning does not work, enter this secret manually in your
              authenticator app.
            </p>
