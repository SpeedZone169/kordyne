...
import type { ProviderPackageDetailFile } from "./types";
import ApsProviderPackageFilePreview from "./ApsProviderPackageFilePreview";
import { providerFileSourceTypeLabels } from "@/lib/providers";
import StlPreview from "../../../dashboard/parts/[id]/StlPreview";
...
function getTypeBadgeClass(file: ProviderPackageDetailFile) {
...
function buildGroupedFiles(files: ProviderPackageDetailFile[]) {
  const grouped: Record<string, ProviderPackageDetailFile[]> = {
    cad_3d: [],
    drawing_2d: [],
    image: [],
    manufacturing_doc: [],
...
export default function ProviderPackageFilesViewer({ files }: Props) {
  ...
  const isStepSelected =
    selectedExtension === "step" || selectedExtension === "stp";
    ...
    <div className="grid gap-6 xl:grid-cols-[360px_minmax(0,1fr)]">
      <div className="rounded-[28px] border border-slate-200 bg-slate-50/70 p-4">
        <div className="mb-4 flex items-center justify-between gap-4 px-2">
          <div>
            <h3 className="text-lg font-semibold text-slate-950">Shared files</h3>
                  ...
                  <div className="flex h-full min-h-[560px] flex-col items-center justify-center bg-[radial-gradient(circle_at_top,#eff6ff,#f8fafc_55%,#ffffff)] px-8 text-center">
                    <div className="max-w-xl">
                      ...
                      <p className="mt-3 text-sm leading-7 text-slate-600">
                        The preview area is already in place. STL is live, STEP is
                        handled with APS, and additional CAD formats can be added
            ...
            <div className="mt-5 grid gap-3 md:grid-cols-3">
              <div className="rounded-[20px] border border-slate-200 bg-slate-50 p-4">
                ...
                <div className="mt-2 font-medium text-slate-900">
                  {formatDateTime(selectedFile.sharedAt || selectedFile.createdAt)}
                </div>
              </div>
              ...
              <div className="rounded-[20px] border border-slate-200 bg-slate-50 p-4">
                ...
                <div className="mt-2 font-medium text-slate-900">
                  {providerFileSourceTypeLabels[selectedFile.sourceType] ??
